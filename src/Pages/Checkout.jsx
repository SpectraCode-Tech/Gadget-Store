...
const Checkout = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
      <h1 className="text-3xl font-bold text-slate-900 mb-8">Checkout Desk</h1>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white p-6 border border-slate-200 rounded-xl space-y-4">
            <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              <Truck className="w-5 h-5 text-brand-blue" /> Shipping Destination
            </h2>
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-brand-blue transition"
                />
              </div>
          ...
          <div className="bg-white p-6 border border-slate-200 rounded-xl space-y-4">
            <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              <CreditCard className="w-5 h-5 text-brand-blue" /> Settlement
              Method
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* COD Option Selection Box */}
              <label
                className={`p-4 border rounded-xl flex items-center gap-3 cursor-pointer transition ${paymentMethod === "cod" ? "border-brand-blue bg-blue-50/20" : "border-slate-200"}`}
              >
                <input
                  type="radio"
                  name="paymentMethod"
                  ...
                  className="text-brand-blue focus:ring-0"
                />
                <div>
              ...
              <label
                className={`p-4 border rounded-xl flex items-center gap-3 cursor-pointer transition ${paymentMethod === "card" ? "border-brand-blue bg-blue-50/20" : "border-slate-200"}`}
              >
                <input
                  type="radio"
                  name="paymentMethod"
        ...
        <div className="lg:col-span-5">
          <div className="bg-white p-6 border border-slate-200 rounded-xl space-y-4 sticky top-6">
            ...
            <button
              ...
              className="w-full py-3.5 bg-brand-blue text-white font-bold rounded-xl hover:bg-blue-600 transition shadow-sm disabled:opacity-50"
            >
              {isSubmitting
