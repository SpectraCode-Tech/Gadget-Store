...
const HomeAdBanner = () => {
  return (
    <section className="flex-1 p-4 md:p-6 h-full">
      <div className="relative w-full h-full rounded-3xl overflow-hidden bg-linear-to-br from-blue-950 via-blue-900 to-blue-800 shadow-2xl flex flex-col md:flex-row items-center">
        ...
        <div className="relative z-10 hidden md:flex flex-1 h-full items-center justify-center p-10">
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute w-72 h-72 bg-linear-to-br from-orange-400/30 to-blue-400/20 rounded-full blur-2xl" />
            ...
            <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-4xl p-10">
